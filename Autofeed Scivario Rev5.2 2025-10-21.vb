...
'==========================================================================================
    ...
    Case 3 'assign new values for interval time and specified target weight to feed
        ...
        ElseIf .intB = 0 And .inoculationTime_H < (s(6) + sampleDelay) And ((.runtime_H - .PhaseStart_H) > 0.1 / 60) Then 'Waiting for intB to confirm sample
            ...
            .intT = s(6) - .inoculationTime_H 'time to feed in hours. 
            .phase = .phase + 1
        ElseIf .intB = 1 And .inoculationTime_H > s(6) 'if sample is confirmed before phase 4, this message will display, unlikely to happen
            .intT = s(6) - .inoculationTime_H 'time to feed in hours. 
...
'==========================================================================================
    ...
    Case 10 'Glucose Decision Tree
        ...
        If .intB = 0 AndAlso .inoculationTime_H < (s(6) + sampleDelay) Then 'skips glucose if sample not confirmed
...
'==========================================================================================
    ...
    Case 11 'potential skip of glucose
        ...
        If .intB = 0 and .inoculationTime_H > (s(6) + sampleDelay) Then 'skips glucose if sample not confirmed
            .logwarning("██ - Phase: 11 - ██ - Day: " & procDay & " - ██ - Unit #: " & .unit & ". - ████ - Skipping glucose feed, sample not verified")
            .phase = .phase + 4
        ElseIf .intB = 1 Then 'if not entered until after feed
            .phase = .phase + 1
        End If
