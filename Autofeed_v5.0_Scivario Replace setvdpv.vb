...
'==========================================================================================
    ...
    Case 8 'Prepare for feed A 
        ...
        '--- MODIFIED: Record baseline instead of resetting ---
        s(13) = .VDPV  'Record Feed A totalizer baseline at start of interval
...
'==========================================================================================
    ...
    Case 9 'Feed A runs
        ...
        '--- MODIFIED: Calculate fed amount relative to baseline ---
        Dim FeedA_Fed_Totalizer As Double
        FeedA_Fed_Totalizer = .VDPV - s(13)  'Current totalizer minus baseline
        ...
        If abs(MajorFeed_Fed) > s(4) and (.runtime_H - .phaseStart_H) > 0.1/60 Then '(s(1) - s(2)) > s(12)
            .pumpDActive = False
            .intF = s(2) - s(3) 'Feed A Fed by scale
...
'==========================================================================================
    ...
    Case 14 'glucose feed 
        ...
        Glucose_Fed_Totalizer = .VEPV - s(14)  'Current totalizer minus baseline
